...
<main>
    <div class="kibana-wrapper">
        ...
        <iframe 
            class="kibana-iframe"
            src="http://localhost:5601/app/dashboards#/view/45e96950-018c-11f1-9d3e-5fb803ff8476?embed=true&_g=(filters%3A!()%2CrefreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(from%3Anow-1y%2Cto%3Anow))">
        </iframe>
    </div>
</main>
